...
def joint(name,typ,locPart,loc,parent,child,dirPart,dir):
    ...
    ET.SubElement(limit,'lower').text='-1.79e308'
    ET.SubElement(limit,'upper').text='1.79e308'
    return joi11
...
for i in range(1,7):
    ...
    joint1 = joint('crevjoin{0}0'.format(i),'revolute','nframe{0}0'.format(i),[0,0,0,0,0,0],pare,chil,chil,'0 1 0')
...
for i in range(1,7):
    ...
    joint1 = joint('crevjoin{0}1'.format(i),'revolute','nframe{0}1'.format(i),[0,0,0,0,0,0],pare,chil,chil,'0 1 0')
    model.append(frame11)
    model.append(joint1)
for i in range(1,7):
    chil = 'link{0}2'.format(i)
    ...
    joint1 = joint('crevjoin{0}2'.format(i),'revolute','nframe{0}2'.format(i),[0,0,0,0,0,0],pare,chil,chil,'0 1 0')
    model.append(frame11)
    model.append(joint1)
for i in range(1,7):
    chil = 'link{0}3'.format(i)
    ...
    joint1 = joint('crevjoin{0}3'.format(i),'revolute','nframe{0}3'.format(i),[0,0,0,0,0,0],pare,chil,chil,'0 1 0')
    model.append(frame11)
    model.append(joint1)
root = ET.Element('sdf')
...
tree.write('/home/cbb/gz_models/robot/robot1.sdf', encoding='utf-8', xml_declaration=True)